...
run_test "switch create sw01 --model_type openvswitch --address tcp:10.30.83.20:6640 --mac 10:1F:74:32:F7:49" '"name": "sw01"'
run_test "switch int_attach sw01 --inter 84:2b:2b:00:96:22" '"id": "84:2b:2b:00:96:22"'
run_test "switch int_attach sw01 --inter 84:2b:2b:00:96:21" '"error": "EntityNotFound"'
