...
run_test "pod create pod01 --datacenter datacenter01" '"message": "Zone:pod01 already exists Forbidden"'
...
run_test "firewall create firewall01 --pod pod01" '"message": "Firewall:firewall01 already exists Forbidden"'
run_test "vlan create vlan01 --pod pod01 --type private_vlan" '"name": "vlan01"'
...
run_test "pod create pod01 --datacenter datacenter01" '"name": "pod01"'
run_test "vlan create vlan01 --pod pod01 --type private_vlan" '"name": "vlan01"'
run_test "vlan create vlan01 --pod pod01 --type private_vlan" '"message": "Vlan:vlan01 already exists Forbidden"'
...
run_test "vlan create vlan01 --pod pod01 --type private_vlan" '"name": "vlan01"'
run_test "vlan create vlan02 --pod pod02 --type private_vlan" '"name": "vlan02"'
...
run_test "interface ip_detach 84:2b:2b:00:96:22 192.168.0.1" '"error": "EntityNotFound"'
