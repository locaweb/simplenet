...
run_test "interface create 84:2b:2b:00:96:22" '"mac": "84:2b:2b:00:96:22"'
run_test "interface attach_ip 84:2b:2b:00:96:22 192.168.0.1" '"mac": "84:2b:2b:00:96:22"'
run_test "interface attach_ip 84:2b:2b:00:96:22 192.168.0.1" '"message": "Exception(FlushError(.*"'
run_test "interface attach_ip 84:2b:2b:00:96:22 192.168.0.2" '"mac": "84:2b:2b:00:96:22"'
run_test "interface attach_ip 84:2b:2b:00:96:22 192.168.0.3" '"error": "EntityNotFound"'
run_test "interface attach_ip 84:2b:2b:00:96:21 192.168.0.2" '"error": "EntityNotFound"'
run_test "ip delete 192.168.0.1" '"message": "Exception(IntegrityError'
run_test "interface detach_ip 84:2b:2b:00:96:22 192.168.0.2" '"message": "Successful deletetion"'
run_test "interface detach_ip 84:2b:2b:00:96:22 192.168.0.1" '"message": "Successful deletetion"'
run_test "interface detach_ip 84:2b:2b:00:96:22 192.168.0.2" '"message": "Exception(UnmappedInstanceError'
run_test "ip delete 192.168.0.1" '"message": "Successful deletetion"'
